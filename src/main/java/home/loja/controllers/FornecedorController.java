...
import home.loja.dto.fornecedor.ConsultaFornecedorDTO;
import home.loja.dto.fornecedor.FornecedorMapper;
import home.loja.dto.fornecedor.RegistroFornecedorDTO;
import home.loja.entities.Fornecedor;
import home.loja.services.FornecedorService;
...
public class FornecedorController {
    ...
    public ResponseEntity<Page<ConsultaFornecedorDTO>> buscarTodosOsFornecedores(@PageableDefault() Pageable pageable) {
        ...
        return ResponseEntity
                .ok(fornecedorService.listarTodosOsFornecedores(pageable).map(FornecedorMapper::fromEntity));
    }
